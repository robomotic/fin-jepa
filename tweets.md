...
Here is what we found. Thread below.
...
- FRED macro (rates, inflation, labour, financial conditions)
...
The model is encoding *regimes*, not equity momentum.
...
The latent vector shifts by 7.8 units (large). But it points in the wrong direction vs the training-period shock axis.
...
The binding constraint on this whole study: 770 valid training windows.
...
- Macro channels drive the representation; equity channels do not
